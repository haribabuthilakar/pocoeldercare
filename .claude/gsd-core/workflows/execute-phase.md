...
@C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/agent-contracts.md
@C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/context-budget.md
@C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/gates.md
</required_reading>
...
@C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/execute-phase-response-language.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `C:/Users/harib/work/pocoeldercare/.claude/gsd-core/workflows/execute-plan.md` **inline**
...
@C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/execute-phase-wave-guard.md

@C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/execute-phase-context-guard.md
   ...
   Agent(
    ...
    description="Execute plan {plan_number} of phase {phase_number}",
     ...
     prompt="
       ...
       - `C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/checkpoints.md`
       - `C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/tdd.md`
       - `C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/worktree-path-safety.md`
       ${CONTEXT_WINDOW < 200000 ? '' : '- `C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/executor-examples.md`'}
       </execution_context>
...
@C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/execute-phase-quota-recovery.md

@C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/execute-phase-between-wave-reset.md
...
**If gaps_found:**
@C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/execute-phase-requirement-revert.md
```
...
@C:/Users/harib/work/pocoeldercare/.claude/gsd-core/workflows/transition.md
</step>
