...
const seedContent = `import { PrismaClient, RoleType, PlanTierName, ServiceCategoryName, AbhaSyncStatus } from '@prisma/client';
...
fs.writeFileSync(path.resolve('packages/database/prisma/seed.ts'), seedContent, 'utf8');
console.log('Successfully wrote packages/database/prisma/seed.ts');
