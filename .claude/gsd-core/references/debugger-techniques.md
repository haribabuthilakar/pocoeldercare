...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Users/harib/work/pocoeldercare/.claude
                  → checks C:/Users/harib/work/pocoeldercare/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/harib/work/pocoeldercare/.claude/gsd-core
                  → writes to C:/Users/harib/work/pocoeldercare/.claude/gsd-core/hooks/
