...
const contextContent = `# Phase 3: Field App for Care Officers - Context & Decisions
...
writeFile('.planning/phases/03-field-app-for-care-officers/03-CONTEXT.md', contextContent);
