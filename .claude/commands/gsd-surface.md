...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/harib/work/pocoeldercare/.claude/.gsd-surface.json`
(sibling to `C:/Users/harib/work/pocoeldercare/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/harib/work/pocoeldercare/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Users/harib/work/pocoeldercare/.claude/skills`).
...
`C:/Users/harib/work/pocoeldercare/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/harib/work/pocoeldercare/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/harib/work/pocoeldercare/.claude/.gsd-surface.json`
Install profile marker: `C:/Users/harib/work/pocoeldercare/.claude/.gsd-profile`
Skill dirs: `C:/Users/harib/work/pocoeldercare/.claude/skills/gsd-*/`
Engine module: `C:/Users/harib/work/pocoeldercare/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/harib/work/pocoeldercare/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
