...
**Verification depth scales with `asvs_level`** (see @C:/Users/harib/work/pocoeldercare/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
