...
```
Agent(
  prompt="Read C:/Users/harib/work/pocoeldercare/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/harib/work/pocoeldercare/.claude/gsd-core/templates/VALIDATION.md`
